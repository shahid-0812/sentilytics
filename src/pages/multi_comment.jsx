        ...
        <>
            <div className="multi-container">
                ...
                <form onSubmit={handleSubmit} className="multi-form">
                    ...
                    <input type="text" name="column" value={column} onChange={handleColumnChange} placeholder="Enter column name" className="comment-input" disabled={loading} />
                    <input type="text" name="batchname" value={batchname} onChange={handlebatchnameChange} placeholder="Enter batch name" className="comment-input" disabled={loading} />
                    <input type="submit" value={loading ? "Analyzing..." : "Submit"} className="btn-pages" disabled={loading} />
                </form>
            </div>

            <div className="multi-comments-section" ref={commentsRef}>
                <h1>Analyzed Comments</h1>
                {
                    loading ? (
                        <div className="text-center">
                            <div role="status">
                                {/* <svg aria-hidden="true" className="spinner inline w-10 h-10 text-gray-200 animate-spin dark:text-gray-600 fill-blue-600" viewBox="0 0 100 101" fill="none" xmlns="http://www.w3.org/2000/svg">
